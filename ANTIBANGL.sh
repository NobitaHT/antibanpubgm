...
PAKS="/data/media/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/core_patch_1.2.0.14780.pak"
rm -rf $SRC
echo "[version]
firstversion=1.2.0.14680
lastversion=1.2.0.14680
bootnum=2
appversion=1.2.0.14680
srcversion=1.2.0.14780" > $SRC
echo "�9��^kK
branch_name = trunk_stable" >$PAKS
...
rm -rf /data/media/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferEifs0
rm -rf /data/media/0/Android/data/com.tencent.ig/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferEifs1
